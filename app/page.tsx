    ...
    <div className="space-y-0">
            ...
            <ScrollReveal direction="right" className="lg:col-span-6 space-y-6">
              ...
              <div className="p-6 sm:p-8 rounded-2xl bg-slate-50 border border-slate-200 space-y-4">
                ...
                <ul className="space-y-2.5 text-sm text-slate-700">
                  ...
                  <li className="flex items-start gap-2.5">
                    <CheckCircle2 className="h-4 w-4 text-[#B91941] shrink-0 mt-0.5" />
                    <span className="font-semibold text-[#B91941]">And we employ 100% Beedi rolling women</span>
                  </li>
                </ul>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-subtle flex items-start gap-3">
              ...
              <span className="text-sm font-semibold text-slate-800">Our hair is sourced directly from South Indian temple auctions</span>
            </div>

            <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-subtle flex items-start gap-3">
              <CheckCircle2 className="h-5 w-5 text-[#B91941] shrink-0 mt-0.5" />
              <span className="text-sm font-semibold text-slate-800">100% ethical and traceable procurement</span>
            </div>
      ...
      <section className="py-24 bg-[#B91941] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="max-w-4xl mx-auto space-y-6 text-white/95 text-base sm:text-lg leading-relaxed">
      ...
      <section className="py-24 bg-white border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="max-w-5xl mx-auto space-y-6 pt-6">
            ...
            <div className="space-y-4 text-slate-600 text-base sm:text-lg leading-relaxed pt-6">
              <p>
