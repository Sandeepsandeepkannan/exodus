          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 pb-6 border-b border-slate-200">
            ...
            <div className="relative w-full md:w-72">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 rounded-lg border border-slate-200 text-xs focus:outline-none focus:ring-2 focus:ring-[#B91941] focus:border-transparent"
              />
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 max-w-6xl mx-auto">
            <div className="p-6 rounded-xl bg-slate-50 border border-slate-200 text-center space-y-3">
              ...
              <h3 className="font-bold text-slate-900 text-sm font-display">Procurement</h3>
            ...
            <div className="p-6 rounded-xl bg-slate-50 border border-slate-200 text-center space-y-3">
              ...
              <h3 className="font-bold text-slate-900 text-sm font-display">Washing</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {hairColours.map((shade, idx) => (
              <div key={idx} className="p-6 rounded-xl bg-white border border-slate-200 shadow-subtle flex items-center gap-3">
                <Palette className="h-5 w-5 text-[#B91941] shrink-0" />
                <span className="text-sm font-bold text-slate-900 font-display">{shade}</span>
              </div>
            ))}
          </div>
