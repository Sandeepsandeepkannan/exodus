    ...
    <div className="space-y-0 pt-28">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 flex items-start gap-3">
              ...
              <span className="text-xs sm:text-sm font-semibold text-slate-800">Coloured and bleached</span>
            </div>
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 flex items-start gap-3">
              <CheckCircle2 className="h-5 w-5 text-[#A9153B] shrink-0 mt-0.5" />
              <span className="text-xs sm:text-sm font-semibold text-slate-800">Heat styled and curled</span>
            </div>
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 flex items-start gap-3">
              <CheckCircle2 className="h-5 w-5 text-[#A9153B] shrink-0 mt-0.5" />
              <span className="text-xs sm:text-sm font-semibold text-slate-800">Washed, blow-dried, and reused</span>
            </div>
            <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 flex items-start gap-3">
              <CheckCircle2 className="h-5 w-5 text-[#A9153B] shrink-0 mt-0.5" />
              <span className="text-xs sm:text-sm font-semibold text-slate-800">Worn continuously for long periods with proper care</span>
            </div>
          </div>

          <div className="max-w-4xl mx-auto space-y-6 text-slate-600 text-sm sm:text-base leading-relaxed text-center">
      ...
      <section className="py-24 bg-[#A9153B] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl text-center space-y-8">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 border border-white/20 text-white text-[11px] sm:text-xs font-bold uppercase tracking-wider">
          ...
          <div className="space-y-6 text-white/95 text-sm sm:text-base leading-relaxed">
            ...
            <p className="font-bold text-white bg-white/10 p-6 rounded-2xl border border-white/20 text-sm sm:text-base">
      ...
      <section className="py-24 bg-white border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <ScrollReveal className="text-center max-w-3xl mx-auto space-y-4">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#A9153B]/5 border border-[#A9153B]/10 text-[#A9153B] text-[11px] sm:text-xs font-bold uppercase tracking-wider">
              <span className="h-1.5 w-1.5 rounded-full bg-[#A9153B]"></span> Buyer’s guide
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="p-8 sm:p-10 rounded-2xl bg-slate-50 border border-slate-200 shadow-subtle flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="text-[11px] font-bold text-[#A9153B] uppercase tracking-wider flex items-center gap-1.5">
            ...
            <div className="p-8 sm:p-10 rounded-2xl bg-slate-50 border border-slate-200 shadow-subtle flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                ...
                <div className="pt-2 space-y-1.5">
                  <div className="text-[11px] font-bold text-slate-900 uppercase tracking-wider">Disadvantages:</div>
      ...
      <section className="py-24 bg-slate-50 border-b border-slate-200/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <ScrollReveal className="text-center max-w-3xl mx-auto space-y-4">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#A9153B]/5 border border-[#A9153B]/10 text-[#A9153B] text-[11px] sm:text-xs font-bold uppercase tracking-wider">
              <span className="h-1.5 w-1.5 rounded-full bg-[#A9153B]"></span> Care & application
            </div>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-900 font-display">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-5xl mx-auto items-start">
            ...
            <div className="lg:col-span-5 p-8 rounded-2xl bg-white border border-slate-200 shadow-subtle space-y-4">
              <h3 className="text-lg sm:text-xl font-bold text-slate-900 font-display flex items-center gap-2">
                <Scissors className="h-5 w-5 text-[#A9153B]" /> Professional application
              </h3>
            ...
            <div className="lg:col-span-7 p-8 rounded-2xl bg-white border border-slate-200 shadow-subtle space-y-4">
              <h3 className="text-lg sm:text-xl font-bold text-slate-900 font-display flex items-center gap-2">
                <Droplets className="h-5 w-5 text-[#A9153B]" /> Maintenance guidelines
              </h3>
