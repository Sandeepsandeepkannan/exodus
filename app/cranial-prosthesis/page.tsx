          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <ScrollReveal direction="right" className="lg:col-span-5 space-y-6">
              <div className="relative rounded-2xl overflow-hidden shadow-elevated border border-slate-200 bg-slate-100 group">
                ...
                <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-slate-950/90 via-slate-900/60 to-transparent p-6 text-white">
                  <div className="font-bold text-lg sm:text-xl font-display">Medical-Grade Cranial Prosthesis</div>
                  <div className="text-white/90 text-[11px] font-medium mt-0.5">Custom-Made 100% Natural Human Hair</div>
                </div>
              </div>
            ...
            <ScrollReveal direction="left" className="lg:col-span-7 space-y-6">
              ...
              <div className="space-y-6 text-slate-600 text-sm sm:text-base leading-relaxed">
                ...
                <div className="p-6 rounded-2xl bg-slate-50 border-l-4 border-[#A9153B] space-y-3">
                ...
                <div className="p-6 rounded-2xl bg-[#A9153B]/5 border border-[#A9153B]/20 space-y-2">
                  <p className="font-bold text-[#A9153B] text-base sm:text-lg">
